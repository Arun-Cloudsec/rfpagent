...
router.post('/chat', async (req, res, next) => {
  try {
    ...
    const system = [
      ...
      'You give concise, professional, evidence-based answers.',
      '',
      'CRITICAL — CITATIONS:',
      'When you make a claim that comes from the RFP itself, attribute it using these formats so the UI can render coloured pills:',
      '  • Requirement IDs: write them as "[REQ-001]" with square brackets.',
      '  • RFP sections: write them as "Section 4.2".',
      '  • Page references: write them as "Page 7".',
      'Use the Requirements Map below to find IDs/sections/pages, and use [[PAGE n]] markers in the RFP snippet to find the page for raw quotes.',
      'If you cannot cite a claim because the RFP does not contain that information, say so explicitly.',
      '',
      'STYLE:',
      '• 1–4 short paragraphs unless the user asks for a list.',
